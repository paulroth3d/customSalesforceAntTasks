...
public class PackageUtil {
	...
	public static final String[][] META_MAP = {
		...
		{ "GlobalValueSetTranslation", "globalValueSetTranslations", ".globalValueSetTranslation" },
		{ "Group", "groups", ".group" },
	...
	public static final String[][] FOLDER_META_MAP = {
		...
		{ "entitlementProcesses", "EntitlementProcess", ".entitlementProcess" },
		...
		{ "globalValueSetTranslations", "GlobalValueSetTranslation", ".globalValueSetTranslation" },
		{ "groups", "Group", ".group" },
		...
		{ "letterhead", "Letterhead", ".letterhead" },
		{ "milestoneTypes", "MilestoneType", ".milestoneType" },
